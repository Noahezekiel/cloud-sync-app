...
//       <Layout section={section} setSection={setSection} displayName={displayName} email={email}>
...
//                 <span className="breadcrumb" onClick={() => setCurrentPath("uploads/")}>
//                   uploads
//                 </span>
//                 {currentPath
//                   .replace("uploads/", "")
...
//                   .filter(Boolean)
//                   .map((part, i, arr) => {
//                     const path = "uploads/" + arr.slice(0, i + 1).join("/") + "/";
//                     return (
//                       <span key={i}>
//                         {" / "}
//                         <span className="breadcrumb" onClick={() => setCurrentPath(path)}>
//                           {part}
//                         </span>
//                       </span>
//                     );
...
//                   onFolderOpen={(folderKey) =>
//                     setCurrentPath(folderKey.endsWith("/") ? folderKey : folderKey + "/")
//                   }
//                   clipboard={clipboard}
